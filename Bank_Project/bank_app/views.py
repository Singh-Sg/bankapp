...
#                 account=account, amount=amount, balance=new_balance, statement_type = "deposit"
#             )
...
#             Statement.objects.create(
#                 account=account, amount=-amount, balance=new_balance, statement_type = "withdrawal"
#             )
...
#             # Create statements for transfer
#             Statement.objects.create(
#                 account=from_account, amount=-amount, balance=from_account.balance, statement_type = "transfer"
#             )
#             Statement.objects.create(
#                 account=to_account, amount=+amount, balance=to_account.balance, statement_type = "transfer"
#             )
