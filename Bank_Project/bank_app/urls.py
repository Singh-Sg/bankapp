...
urlpatterns = [
    ...
    path('api/withdrawal/<int:account_number>/', withdrawal.as_view(), name='withdrawal'),    
    path('api/transfer/', MoneyTransferAPIView.as_view(), name='transfer'),    
    path('api/StatementAPIView/<int:account_number>/', StatementAPIView.as_view(), name='statement'),    
]
